...
import { ResourcesChart, ResourcesChartData } from '../data/resources-chart';
...
export class ResourcesChartService extends ResourcesChartData {
  ...
  private getDataForWeekPeriod(): ResourcesChart {
    return {
  ...
  private getDataForMonthPeriod(): ResourcesChart {
    return {
  ...
  private getDataForYearPeriod(): ResourcesChart {
    return {
  ...
  getResourcesChartData(period: string): ResourcesChart {
